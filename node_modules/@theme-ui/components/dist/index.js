...
var AspectImage = React.forwardRef(function (ref$1, ref) {
  ...
  return React.createElement( AspectRatio, { ratio: ratio },
    React.createElement( Image, Object.assign({}, { ref: ref }, props, { sx: Object.assign({}, {objectFit: 'cover'},
    sx) }))
  );
});
...
var NavLink = React.forwardRef(function (props, ref) { return React.createElement( Link, Object.assign({}, { ref: ref, variant: 'nav' }, props, { sx: Object.assign({}, {color: 'inherit',
  textDecoration: 'none',
  fontWeight: 'bold',
  display: 'inline-block',
  '&:hover, &:focus, &.active': {
